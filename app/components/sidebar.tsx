...
export default function Sidebar({ sidebarState, setSidebarState }: { sidebarState: boolean, setSidebarState: Dispatch<SetStateAction<boolean>> }) {
  return (
    <>
      {
        <div className={`overflow-clip left-0 top-0 bg-gray-200 md:hidden absolute h-screen duration-300 ${sidebarState ? 'animate-slideIn w-1/2 sm+:w-1/3' : 'animate-slideOut w-0'}`}>
