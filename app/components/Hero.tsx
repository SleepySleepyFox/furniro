...
export default function Hero() {
  // ADD container div 
  // on bigger screens when bg-img is centered use this external div container to help with positioning other hero section ellements 
  return (
    <div>
      <div className='flex justify-center md:justify-end md:items-start lg+:items-center w-screen h-screen md:h-[717px] md:bg-auto md:bg-hero-pattern md:bg-no-repeat md:bg-center lg+:bg-cover lg+:h-[800px]'>
        <div className='w-screen flex-shrink lg:min-h-[350px] md:h-[300px] md:w-[440px] lg:w-[600px] md:self-center lg:max-h-[400px] md:relative md:right-14 md:gap-2 md:text-start md:p-4 lg:p-9 bg-[#FFF3E3] md:rounded-lg  flex flex-col justify-center text-center gap-4 px-2'>
